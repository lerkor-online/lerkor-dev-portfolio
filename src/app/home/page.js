        ...
        <div className='h-screen bg-light-whitecustom'>
            <section id="landing-header" className='h-screen flex justify-center items-center flex-col gap-6'>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <button className='bg-light-purplecustom hover:bg-light-blackcustom bg-light-redlight hover:shadow-light-purplecustom hover:shadow-sm text-light-whitecustom font-bold py-2 px-4 rounded'>
