        ...
        <div className=' bg-light-whitecustom dark:bg-light-blackcustom'>
            <section id="landing-header" className='h-screen flex justify-center items-center flex-col gap-6'>
                ...
                <div className='flex flex-wrap gap-6 z-10'>
                    ...
                    <button className=' bg-light-redbold dark:bg-dark-600 hover:bg-light-blackcustom dark:hover:bg-dark-700 shadow-lg text-light-whitecustom dark:text-dark-800 dark:hover:text-dark-600 dark:shadow-dark-300 dark:hover:shadow-dark-600 font-bold rounded dark:hover:border-dark-800 dark:border-2 dark:border-dark-300 dark:animate-bounce dark:delay-200 bg-opacity-90 p-2'>
