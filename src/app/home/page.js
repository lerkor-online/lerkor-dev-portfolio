...
const Home = () => {
    ...
    return (
        <div className='h-screen bg-light-whitecustom'>
            <section id="landing-header" className='h-screen flex justify-center items-center flex-col gap-6'>
                ...
                <div className='flex flex-wrap gap-6'>
                    <button className='bg-light-bluecustom hover:bg-light-blackcustom bg-light-redlight hover:shadow-light-bluecustom hover:shadow-sm text-light-whitecustom font-bold py-2 px-4 rounded'>
                    ...
                    <button className='bg-light-purplecustom bg-light-redlight hover:shadow-light-purplecustom hover:shadow-sm text-light-whitecustom font-bold py-2 px-4 rounded'>
                        <a href="https://github.com/lerkor-dev" target="_blank" rel="noopener noreferrer">
                    ...
                    <button className='bg-light-bluecustom bg-light-redlight hover:shadow-light-bluecustom hover:shadow-sm text-light-whitecustom font-bold py-2 px-4 rounded'>
